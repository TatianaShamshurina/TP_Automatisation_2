...
class Steps_08:
    ...
    def choose_product(self):
        ...
        self.driver.implicitly_wait(5)
        self.driver.find_element(By.XPATH, "//h1[normalize-space()='Your order has been placed!']").is_displayed()
        self.driver.implicitly_wait(5)
        self.driver.save_screenshot("Exigence 08 passer une commande.png")
