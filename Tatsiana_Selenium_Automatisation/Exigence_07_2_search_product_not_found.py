...
driver.find_element(By.XPATH,"//p[contains(text(),'There is no product that matches the search criter')]").is_displayed()
driver.save_screenshot("Exigence 07-2 Search product not found.png")
